...
public class ExternalizableUtil {
	...
	public static void main(String args[]) {
		...
		ExternalizableClass serializableClassObj = new ExternalizableClass();
		...
		ExternalizableClass deserializableClassObj = new ExternalizableClass();
		serializableClassObj.setVariable1("This is Variable 5");
		SerializableClass.variable3 = "This is variable 4";
		
		try {
			deserializableClassObj = (ExternalizableClass) deserialize(filename);
