...
public final class ImmutableClassSimple {
	...
	public ImmutableClassSimple(int i, String n, HashMap<String, String> hm) {
	...
	public static void main(String[] args) {
		...
		ImmutableClassSimple ce = new ImmutableClassSimple(i, s, h1);
